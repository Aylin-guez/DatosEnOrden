...
style = {
    ...
    ".public-money-total": {"font_size": "30px", "font_weight": "850", "color": "#2dd4bf", "line_height": "1"},
    ".public-money-universe": {"display": "grid", "gap": "6px", "border_color": "rgba(45, 212, 191, 0.38)"},
    ".public-money-observation": {"display": "grid", "gap": "4px", "min_width": "0"},
    ".public-money-instrument": {"display": "grid", "gap": "10px", "align_content": "start"},
    ".public-money-snapshot": {"display": "grid", "gap": "12px", "border_color": "rgba(167, 139, 250, 0.36)"},
    ".public-money-action": {"display": "grid", "gap": "12px", "border_color": "rgba(250, 204, 21, 0.32)"},
    ".public-money-proceeding": {"display": "grid", "gap": "8px"},
    ".public-money-notice": {"border_left": "3px solid rgba(167, 139, 250, 0.60)", "padding_left": "10px"},
