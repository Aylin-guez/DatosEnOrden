...
dataset_slug = "sanciones_procedimientos"
dataset_name = "Sanciones y Procedimientos"
dataset_description = "Local prototype dataset for administrative procedures and resolution records."
dataset_names = ("sanciones-procedimientos-sample",)
source_names = ("DatosEnOrden Sanciones Procedimientos Sample",)
aliases = ("sanciones-procedimientos", "procedimientos-administrativos")
planned = False
...
def load_sample_data(input_path=None):  # noqa: ANN001
    from datosenorden.maintenance.sanciones_procedimientos_prototype import load_sanciones_procedimientos_sample_payload

    return jsonify(load_sanciones_procedimientos_sample_payload(input_path))
...
def build_entities(payload=None):  # noqa: ANN001
    ...
    batch = build_sanciones_procedimientos_sample_batch(_null_session(), payload)
