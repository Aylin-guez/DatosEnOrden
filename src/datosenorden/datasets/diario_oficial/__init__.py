...
dataset_slug = "diario_oficial"
dataset_name = "Diario Oficial"
dataset_description = "Dynamic registry entry for the local Diario Oficial publication sample."
dataset_names = ("diario-oficial-sample",)
source_names = ("DatosEnOrden Diario Oficial Sample",)
aliases = ("diario-oficial", "diario-oficial-sample", "diario-oficial-prototype")
planned = False
...
def load_sample_data(input_path=None):  # noqa: ANN001
    from datosenorden.maintenance.diario_oficial_prototype import load_diario_oficial_sample_payload

    return jsonify(load_diario_oficial_sample_payload(input_path))
...
def build_entities(payload=None):  # noqa: ANN001
    ...
    batch = build_diario_oficial_sample_batch(_null_session(), payload)
