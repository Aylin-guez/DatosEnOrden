...
dataset_slug = "transparencia"
dataset_name = "Transparencia Activa"
dataset_description = "Dynamic registry entry for the local Transparencia Activa sample."
...
def load_sample_data(input_path=None):  # noqa: ANN001
    from datosenorden.maintenance.transparencia_activa_prototype import load_transparencia_sample_payload

    return jsonify(load_transparencia_sample_payload(input_path))
...
def build_entities(payload=None):  # noqa: ANN001
    ...
    batch = build_transparencia_sample_batch(_null_session(), payload)
