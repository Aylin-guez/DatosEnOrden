...
dataset_slug = "contraloria"
dataset_name = "Contraloria"
dataset_description = "Local prototype dataset for contraloria control reports and observations."
dataset_names = ("contraloria-control-report-sample",)
source_names = ("DatosEnOrden Contraloria Sample",)
aliases = ("contraloria-sample", "contraloria-control")
planned = False
...
def load_sample_data(input_path=None):  # noqa: ANN001
    ...
    return jsonify(load_contraloria_sample_payload(input_path))
...
def build_entities(payload=None):  # noqa: ANN001
    ...
    batch = build_contraloria_sample_batch(_null_session(), payload)
