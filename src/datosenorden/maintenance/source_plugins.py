...
_SOURCE_PLUGINS: tuple[PublicSourcePlugin, ...] = (
    ...
    PublicSourcePlugin(
        ...
        description="Fuente planificada para declaraciones publicas de intereses y patrimonio.",
        category="integrity",
        coverage=_coverage("future", "Planned source; no local loader yet."),
        concepts=(
            _concept("Persona", "Declarant.", "PERSON"),
        ...
        relationships=(
            _relationship("DECLARES_INTEREST", "Persona", "Declaracion", "Person declares an interest."),
            _relationship("PERSON_HELD_PUBLIC_ROLE", "Persona", "Cargo Publico", "Person held a public role."),
        ),
        compatible_source_ids=("servel", "transparencia_activa", "lobby"),
        commands=(),
        evidence_types=("declaration_record",),
        timeline_contribution="Future declaration dates.",
        search_hints=("declaracion de intereses", "patrimonio"),
        discovery_hints=("which_authorities_appear", "public_offices"),
