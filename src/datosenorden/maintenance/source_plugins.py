...
_SOURCE_PLUGINS: tuple[PublicSourcePlugin, ...] = (
    ...
    PublicSourcePlugin(
        ...
        status=SourceStatus.PROTOTYPE,
        description="Local prototype for administrative procedure and resolution records.",
        category="oversight",
        coverage=_coverage("partial", "Local prototype records are available."),
        concepts=(
            ...
            _concept("Procedimiento administrativo", "Administrative procedure record.", "ADMINISTRATIVE_PROCEDURE"),
            _concept("Resolucion administrativa", "Administrative resolution record.", "ADMINISTRATIVE_RESOLUTION"),
        ),
        relationships=(
            _relationship("PROCEDURE_INVOLVES_ORGANIZATION", "Procedimiento", "Organismo", "Procedure references an organization."),
            _relationship("PROCEDURE_INVOLVES_COMPANY", "Procedimiento", "Empresa", "Procedure references a company."),
            _relationship("PROCEDURE_INVOLVES_PERSON", "Procedimiento", "Persona", "Procedure references a person."),
            _relationship("PROCEDURE_HAS_RESOLUTION", "Procedimiento", "Resolucion administrativa", "Procedure has an administrative resolution record."),
        ),
        compatible_source_ids=("contraloria", "chilecompra", "diario_oficial", "registro_empresas"),
        commands=(
            _command("loader", "python scripts/load_sanciones_procedimientos_sample.py", "Load local sanctions and procedures sample."),
            _command("summary", "python scripts/sanciones_procedimientos_summary.py", "Show sanctions and procedures summary."),
        ),
        evidence_types=("procedure_record", "resolution_record", "local_sample_payload"),
        timeline_contribution="Procedure and administrative resolution dates.",
        search_hints=("sancion", "procedimiento", "resolucion"),
        discovery_hints=("audits", "public_organizations"),
        technical_metadata={"dataset_names": "sanciones-procedimientos-sample", "module": "maintenance.sanciones_procedimientos_prototype"},
