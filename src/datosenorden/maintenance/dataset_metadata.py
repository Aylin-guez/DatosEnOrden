...
_DATASET_METADATA: dict[str, DatasetMetadata] = {
    ...
    "Declaraciones de intereses": DatasetMetadata(
        slug="declaraciones-intereses",
        name="Declaraciones de intereses",
        description="Local prototype of public interest and patrimony declaration records.",
        contributes=(
            "Declaration records",
            "Declared companies",
            "Declared organizations",
            "Public role references",
        ),
        category="integrity",
        citizen_summary="Shows declarations of interests and the people, roles, and entities they reference.",
        status="prototype",
        coverage="partial",
        concepts=("Persona", "Cargo Publico", "Organizacion", "Empresa", "Declaracion"),
        relationships=(
            "PERSON_HAS_DECLARATION",
            "DECLARATION_REFERENCES_COMPANY",
            "DECLARATION_REFERENCES_ORGANIZATION",
            "PERSON_HOLDS_PUBLIC_ROLE",
        ),
        connects_with=("SERVEL", "Transparencia Activa", "Lobby", "Registro Empresas"),
        entities=("Persona", "Cargo Publico", "Organizacion", "Empresa"),
    ),
    "Sanciones y procedimientos": DatasetMetadata(
        slug="sanciones-procedimientos",
        name="Sanciones y procedimientos",
        description="Local prototype of administrative procedure and resolution records.",
        contributes=(
            "Procedure records",
            "Resolution records",
        ...
        category="oversight",
        citizen_summary="Shows administrative procedures and resolutions from the local prototype data.",
        status="prototype",
        coverage="partial",
        ...
        connects_with=("Contraloria", "ChileCompra", "Diario Oficial", "Registro Empresas"),
        entities=("Organismo", "Empresa", "Persona"),
    ),
