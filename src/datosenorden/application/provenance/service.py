...
PROVENANCE_MANIFEST: tuple[ProvenanceManifestEntry, ...] = (
    ...
    ProvenanceManifestEntry(
        source_name="LeyChile",
        dataset_name="control-preventivo-identidad",
        dataset_version="1092269@2026-08-12",
        provenance_class=ProvenanceClass.REAL,
        source_label="LeyChile / BCN / Tribunal Constitucional",
        dataset_identifier="control-preventivo-identidad@1092269:2026-08-12",
        record_scope="postgresql_dataset",
        public_countable=True,
        evidence_basis="Bounded official LeyChile current-law corpus for articles 12 and 12 bis of Law 20.931, with historical amendments, CPP references, BCN legislative history, and the official constitutional-review record identified by hashes and locators.",
        reason="Official current-law, legislative-history, and constitutional-review corpus. It does not infer police powers absent from the reviewed text.",
        confidence="HIGH",
    ),
    ProvenanceManifestEntry(
