...
def parse_args(argv: Sequence[str] | None = None):
    parser = ArgumentParser(description="Inspect persisted ChileCompra traceability")
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        print("No se pudo inspeccionar la traza persistida.", file=sys.stderr)
    ...
    print(render_traceability_chain(traces, args.external_id))
    return 0
